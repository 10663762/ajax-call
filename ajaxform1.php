<html>
  ...
  <input  type="date" class="feedback-input" placeholder="Date" id="date"/> 
   ...
   <input  type="text" class="feedback-input" placeholder="Height in cm" id="ht"/> 
   <input type="text" class="feedback-input" placeholder="Marital Status" id="ms"/> 
  <input type="text" class="feedback-input" placeholder="Home Address (Digital Address)" id="ad"/>
